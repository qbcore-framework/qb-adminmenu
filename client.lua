...
local menu16 = MenuV:CreateMenu(false, "Spawn weapons", menuLocation, 220, 80, 20, 'size-125', 'example', 'menuv', 'test15')
...
for k,v in pairs(weaponsList) do
    local menu_button20 = menu16:AddButton({icon = '🔫',label = v:gsub("%weapon_", ''):gsub('%_', ' '),value = v,description = 'You can spawn this weapon by clicking in the button',select = function(btn)
        local selection = btn.Value
