local Translations = {
    error = {
        ...
        ["invalid_reason_length_ban"] = "Você deve informar um motivo e definir um prazo para o banimento!",
    ...
    info = {
        ...
        ["reason"] = "você precisa dar um motivo",
        ["give"] = "Entregar",
        ["id"] = "ID:",
        ...
        ["ban_perm"] = "\n\nSeu banimento é permanente.\n🔸 Confira nosso Discord para mais informações: ",
        ["ban_expires"] = "\n\nO banimento expira em: ",
        ["rank_level"] = "Seu nível de permissão é agora ",
        ["admin_report"] = "Relatório de administração - ",
        ["staffchat"] = "STAFFCHAT - ",
        ["warning_chat_message"] = "^8WARNING ^7 Você foi avisado por",
