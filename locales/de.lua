local Translations = {
    error = {
        ...
        ["names_deactivated"] = "Names deactiviert",
        ["changed_perm_failed"] = "suche eine Gruppe aus!",
    ...
    info = {
        ...
        ["body_health"] = "Karrosierie Health:",
        ["goto"] = "Gehe zu", 
        ["remove"] = "Entfernen",
        ["confirm"] = "Bestätigen",
        ["reason_title"] = "Grund",
        ...
        ["delete_object_info"] = "Wenn du das Objekt löschen willst klick auf ~g~E", 
        ["obj"] = "Obj",
    ...
    menu = {
        ...
        ["delete_laser"] = "Lösch Laser", 
        ["spawn_vehicle"] = "Spawne Fahrzeug",
        ["fix_vehicle"] = "Fixe Fahrzeug",
        ["buy"] = "Kaufe",
    ...
    desc = {
        ...
        ["revive_desc"] = "Revive dich selbst",
