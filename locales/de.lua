local Translations = {
    ...
    success = {
        ...
        spawn_weapon = 'Du hast eine Waffe gespawned ',
    ...
    info = {
        ...
        entity_freeaim_coords = 'Vec3 kopiert',
        coords_copied = 'Coordinaten kopiert',
    ...
    desc = {
        ...
        hud_dev_mode_desc = 'Aktiviere/Deaktiviere Dev Modus',
        ...
        spawn_weapons_desc = 'Spawne i-eine Waffe.',
        max_mod_desc = 'Tune dein Auto maximal',
    },
    time = {
