local Translations = {
    ...
    info = {
        ...
        vehicle_dev_data = 'Données de véhicule pour développeur :',
        ...
        entity_freeaim_coords = 'Copier le Vec3',
        entity_frozen = 'Gelé',
    ...
    menu = {
        ...
        vehicle_categories = 'Catégories Véhicule',
        vehicle_models = 'Modèles Véhicule',
        ...
        display_coords = 'Afficher les coordonnéess',
    ...
    weather = {
        ...
        rain = 'Pluie',
        rain_desc = 'Que la pluie tombe !',
        thunder = 'Orage',
        thunder_desc = 'Courez et cachez vous!',
        snow = 'Neige',
        snow_desc = 'Fait-il froid dehors ?',
        blizzard = 'Blizzard',
        blizzed_desc = 'Machine à neige ?',
        light_snow = 'Neige légère',
        light_snow_desc = 'Ca commence a sentir comme Noël !',
