local Translations = {
    ...
    weather = {
        ...
        ["weather_changed"] = "%{value} تغير الطقس إلى:", 
    },
    commands = {
        ["blips_for_player"] = "إظهار الإشارات للاعبين (المسؤول فقط)",
        ["player_name_overhead"] = "إظهار اسم اللاعبين (المسؤول فقط)", 
        ["coords_dev_command"] = "تمكين عرض الإحداثيات  (المسؤول فقط)",
        ["toogle_noclip"] = "حالة الطيران (المسؤول فقط)",
        ["save_vehicle_garage"] = "حفظ السيارة في المرآب الخاص بك (المسؤول فقط)",
        ["make_announcement"] = "تقديم إعلان (المسؤول فقط)",
